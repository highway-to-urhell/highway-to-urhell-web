...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "h2hellweb@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "h2hellweb API";

        private String description = "h2hellweb API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "h2hellweb";
